...
for (i = 0; i < evanstonWeather.list.length; i++) {
    if (evanstonWeather.list[i].dt_txt === "2018-03-20 18:00:00") {
        console.log(evanstonWeather.list[i].dt_txt)
        console.log(`The weather on March 20th at 6pm will be ${evanstonWeather.list[i].weather[0].description}`);
    };
}
...
function toFahrenheit(a) {
    return Math.round((a - 273.15) * 1.8 + 32);
};
for (i = 0; i < evanstonWeather.list.length; i++) {
    if (evanstonWeather.list[i].dt_txt === "2018-03-20 21:00:00") {
        let fahrenheit = toFahrenheit(evanstonWeather.list[i].main.temp);
        console.log(`The temperature on March 20th at 9pm will be ${fahrenheit} degrees fahrenheit`);
    };
};
...
function toCardinal(b) {
    let cardinal = Math.round(b / 22.5);
    if (cardinal === 1) return 'N';
    else if (cardinal === 2) return 'NNE';
    else if (cardinal === 3) return 'NE';
    else if (cardinal === 4) return 'ENE';
    else if (cardinal === 5) return 'E';
    else if (cardinal === 6) return 'ESE';
    else if (cardinal === 7) return 'SE';
    else if (cardinal === 8) return 'SSE';
    else if (cardinal === 9) return 'S';
    else if (cardinal === 10) return 'SSW';
    else if (cardinal === 11) return 'SW';
    else if (cardinal === 12) return 'WSW';
    else if (cardinal === 13) return 'W';
    else if (cardinal === 14) return 'WNW';
    else if (cardinal === 15) return 'NW';
    else if (cardinal === 16) return 'NNW';
    else if (cardinal === 17) return 'N';
}
for (i = 0; i < evanstonWeather.list.length; i++) {
    let speed = toMPH(evanstonWeather.list[i].wind.speed)
    let direction = toCardinal(evanstonWeather.list[i].wind.deg)
    if (evanstonWeather.list[i].dt_txt === "2018-03-17 15:00:00") {
        console.log(`The wind will be blowing ${direction} at ${speed} MPH.`);
    };
};

// 5. Write logic to print the humidity each day at noon. If it's over 75%, also print the word "gross" in parentheses
for (i = 0; i < evanstonWeather.list.length; i++) {
    let date = evanstonWeather.list[i].dt_txt.substr(0, 10);
    if (evanstonWeather.list[i].dt_txt.includes('12:00:00') && evanstonWeather.list[i].main.humidity >= 75) console.log(`${date}: ${evanstonWeather.list[i].main.humidity}% (gross)`);
    else if (evanstonWeather.list[i].dt_txt.includes('12:00:00')) console.log(`${date}: ${evanstonWeather.list[i].main.humidity}%`);
};
